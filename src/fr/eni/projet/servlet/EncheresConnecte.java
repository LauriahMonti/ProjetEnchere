...
/**
 * Servlet implementation class EncheresConnecte
 */
@WebServlet("/encheresCo")
public class EncheresConnecte extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EncheresConnecte() {
        super();
    }
		...
		try {
			...
			if(listeArticle != null) {
				...
				this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/indexConnecte.jsp").forward(request, response);
					...
					this.getServletContext().getRequestDispatcher("/rechercheCo").forward(request, response);
				}
			}
