			...
			<div class="col-md-offset-2 col-md-8 col-xs-12 blocProfil">
				...
				<div class="col-md-3 formulaire">
					...
					<input type="text" name="stelephone"
						value="${fn:escapeXml(stelephone)}"><br> <input
						type="text" name="scodePostal" value="${fn:escapeXml(scodePostal)}"><br>
					<input type="password" name="smotDePasse"
						value="${fn:escapeXml(smotDePasse)}">
				</div>
				<div class="col-md-2">
					<p>Nom :</p>
					<p>Email :</p>
